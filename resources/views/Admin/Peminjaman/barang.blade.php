...
"ajax": {
    "url": "{{ url('admin/barang/listbarang/param') }}", // Pastikan URL ini sesuai dengan route listbarang kamu
    "data": function(d) {
        d.param = $('input[name="param"]').val();
        d.ruangan = $("#ruangan").val(); // Pastikan ID #ruangan ada di form modal utama
    }
},
