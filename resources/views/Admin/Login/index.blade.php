...
<div class="container-login100">
    ...
    @if($web->web_logo == '' || $web->web_logo == 'default.png')
        {{-- Mengambil logo default di folder assets --}}
        <img src="{{url('/assets/default/web/default.png')}}" height="75px" alt="logo">
    @else
        {{-- Mengambil logo unggahan di folder assets --}}
    ...
    @endif
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab5">
                            ...
                            <div class="text-end pt-4">
                                <p class="mb-0"><a href="{{ route('admin.forgot.password') }}" class="text-primary ms-1">Forgot Password?</a></p>
                            </div> 
        ...
        <br>
        <center><p>Repost by <a href=https:// title='instagram.com' target='_blank'>Pemerintah Desa Banjarsari</a></p></center>
