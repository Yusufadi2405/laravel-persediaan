...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table id="table-1"
                            ...
                            <thead>
                                ...
                                <th class="border-bottom-0">Ruangan</th>
                                <th class="border-bottom-0">Keterangan</th> <th class="border-bottom-0" width="1%">Action</th>
                            </thead>
                            <tbody></tbody>
                        </table>
                    </div>
 ...
 function update(data) {
    ...
    $("input[name='jmlU']").val(data.bk_jumlah);
        $("select[name='tujuanU']").val(data.bk_tujuan);           // set dropdown ruangan
    $("textarea[name='keteranganU']").val(data.bk_keterangan); // set keterangan
        ...
        $(document).ready(function() {
            ...
            table = $('#table-1').DataTable({
                ...
                "columns": [{
                    ...
                    { data: 'keterangan', name: 'bk_keterangan' },
                    {
                        data: 'action',
                        name: 'action',
                        orderable: false,
