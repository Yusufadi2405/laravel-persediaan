            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label for="stokU" class="form-label">Stok  <span class="text-danger">*</span></label>
...
<script>
   ...
   function submitFormU() {
    ...
    // PERBAIKAN: Gunakan 'fotoU' agar sesuai dengan $request->file('fotoU') di Controller
  
    
    // Perbaikan: Gunakan suffix U pada key agar konsisten dengan controller jika diperlukan
   fd.append('idbarangU', id); 
    ...
    $.ajax({
        type: 'POST',
        // URL disesuaikan dengan route proses_ubah Anda
        ...
        success: function(data) {
            setLoadingU(false); // Pastikan loading dimatikan
            swal({
