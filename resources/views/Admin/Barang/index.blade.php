...
<script>
    ...
    function update(data){
       ...
       $("input[name='stokU']").val(data.barang_stok).attr('readonly', true);
        $("input[name='hargaU']").val(data.barang_harga.replace(/_/g, ' '));
     if (data.barang_gambar && data.barang_gambar !== 'image.png') {
        // Mengarahkan src gambar ke file yang ada di folder assets
        $("#outputImgU").attr("src", "{{ url('/assets/default/barang') }}/" + data.barang_gambar);
    } else {
