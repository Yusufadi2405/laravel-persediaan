                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pwd" class="form-control" placeholder="Password.." autocomplete="new-password">
                            </div>
                            <div class="form-group">
                                <label for="pwdU" class="form-label">Ulangi Password</label>
                                <input type="password" name="pwdU" class="form-control" placeholder="Password.." autocomplete="new-password">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
