...
use App\Http\Controllers\Admin\LapPeminjamanController;
...
Route::middleware(['preventBackHistory'])->group(function () {
 ...
 // Lupa Password
        Route::get('admin/forgot-password', [ForgotPasswordController::class, 'showLinkRequestForm'])->name('admin.forgot.password');
        Route::post('admin/forgot-password', [ForgotPasswordController::class, 'sendOtpCode']);
        Route::get('admin/verify-otp/{email}', [ForgotPasswordController::class, 'showVerifyForm'])->name('admin.verify.otp');
        Route::post('admin/verify-otp', [ForgotPasswordController::class, 'verifyOtp']);
        Route::get('admin/reset-password/{email}', [ForgotPasswordController::class, 'showResetForm'])->name('admin.reset.password');
        Route::post('admin/reset-password', [ForgotPasswordController::class, 'resetPassword']);
...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/barang,submenu'])->group(function () {
        ...
        Route::post('/admin/barang/proses_ubah', [BarangController::class, 'proses_ubah'])->name('barang.proses_ubah');
   ...
   Route::middleware(['checkRoleUser:/lap-barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/admin/barang-keluar/getbarangbyruangan/{id}',  [BarangkeluarController::class, 'getBarangByRuangan']);
    });
     

    // Peminjaman
  Route::middleware(['checkRoleUser:/peminjaman,submenu'])
    ->prefix('admin/peminjaman')
    ->name('peminjaman.')
    ->group(function () {

        Route::get('/', [PeminjamanController::class, 'index'])->name('index');
        Route::get('/get', [PeminjamanController::class, 'get'])->name('get');
        Route::post('/store', [PeminjamanController::class, 'store'])->name('store');
        Route::post('/delete', [PeminjamanController::class, 'delete'])->name('delete');
        Route::get('/detail/{id}', [PeminjamanController::class, 'getDetail'])->name('detail');
        // 🔥 SATU SAJA
        Route::post('/kembalikan/{id}', [PeminjamanController::class, 'kembalikan'])
            ->name('kembalikan');
        Route::get('/barang-by-ruangan/{customer_id}',
            [PeminjamanController::class, 'getBarangByRuangan']
        )->name('barang.by.ruangan');
});
...
Route::middleware(['checkRoleUser:/lap-peminjaman,submenu'])->group(function () {
    Route::get('/admin/lap-peminjaman', [LapPeminjamanController::class, 'index']);
    Route::get('/admin/lap-peminjaman/show', [LapPeminjamanController::class, 'show'])->name('lap-peminjaman.get');
    Route::get('/admin/lap-peminjaman/print', [LapPeminjamanController::class, 'print'])->name('lap-peminjaman.print');
    Route::get('/admin/lap-peminjaman/pdf', [LapPeminjamanController::class, 'pdf'])->name('lap-peminjaman.pdf');
});
